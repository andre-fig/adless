      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item, index) => {
            ...
            const itemConfig = getPayloadConfigFromPayload(config, item, key);
            const itemPayload = item.payload as unknown;
            const fill = isRecord(itemPayload) && typeof itemPayload.fill === "string" ? itemPayload.fill : undefined;
