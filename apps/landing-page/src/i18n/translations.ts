...
export type LegalDocument = {title: string; intro: string; sections: {title: string; paragraphs: string[]; steps: string[]}[]};
export const legalDocuments: Record<Language, Record<LegalPageId, LegalDocument>> = {
  "en": {
    "privacy": {
      "intro": "Adless is developed by Orbe Works. This Privacy Policy explains what happens when you use the Adless iOS app and website.",
      "sections": [
        {
          "paragraphs": [
    ...
    "support": {
      "intro": "Adless is an encrypted DNS protection app for iPhone. It does not use an Adless account and does not proxy your general internet traffic.",
      "sections": [
        {
          "paragraphs": [],
          "steps": [
    ...
    "terms": {
      "intro": "These Terms of Use govern your use of Adless, a DNS filtering application developed by Orbe Works.",
      "sections": [
        {
          "paragraphs": [
  ...
  "pt": {
    "privacy": {
      ...
      "intro": "O Adless é desenvolvido pela Orbe Works. Esta Política de Privacidade explica o que acontece quando você usa o aplicativo Adless para iOS e o site.",
      "sections": [
        {
    ...
    "terms": {
      "title": "Termos de Uso",
      "intro": "Estes Termos de Uso regem seu uso do Adless, um aplicativo de filtragem DNS desenvolvido pela Orbe Works.",
      "sections": [
        {
          "title": "Assinaturas",
          "paragraphs": [
  ...
  "es": {
    "privacy": {
      ...
      "intro": "Adless es desarrollado por Orbe Works. Esta Política de Privacidad explica qué ocurre cuando usas la aplicación Adless para iOS y el sitio web.",
      "sections": [
        {
    ...
    "terms": {
      ...
      "intro": "Estos Términos de Uso rigen tu uso de Adless, una aplicación de filtrado DNS desarrollada por Orbe Works.",
      "sections": [
        {
          "title": "Suscripciones",
          "paragraphs": [
    ...
    "support": {
      ...
      "intro": "Adless es una aplicación de protección DNS cifrada para iPhone. No usa una cuenta Adless ni actúa como proxy de tu tráfico general de internet.",
      "sections": [
        {
