...
const Terms = () => (
  <LegalLayout title="Terms of Use" updatedAt="August 26, 2026">
    <p>
      These Terms of Use govern your use of Adless, a DNS filtering application
      developed by Orbe Works.
    </p>
    ...
    <p>
      Adless provides DNS-based blocking of domains identified by its edge
    ...
    <p>
      ...
      security. DNS protection depends on the saved iOS configuration and network
      availability, so uninterrupted operation cannot be guaranteed.
    </p>
