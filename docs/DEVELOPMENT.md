...
2. App ID do app `com.orbeworks.adless`;
3. App ID da extensão `com.orbeworks.adless.dnsproxy`;
4. App Group `group.com.orbeworks.adless` nos dois targets;
5. capability Network Extensions com `DNS Proxy`;
